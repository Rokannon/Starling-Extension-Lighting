package com.polygon
{
    ...
    public class Triangle
    {
        ...
        public function Triangle(p1:Point, p2:Point, p3:Point, fixOrientation:Boolean = false,
        ...
        public function getConstrainedEdgeCW(p:Point):Boolean
        {
            return this.constrained_edge[getPointIndexOffset(p, CW_OFFSET)];
        }

        public function setConstrainedEdgeCW(p:Point, ce:Boolean):Boolean
        {
            return this.constrained_edge[getPointIndexOffset(p, CW_OFFSET)] = ce;
        }

        public function getConstrainedEdgeCCW(p:Point):Boolean
        {
            return this.constrained_edge[getPointIndexOffset(p, CCW_OFFSET)];
        }

        public function setConstrainedEdgeCCW(p:Point, ce:Boolean):Boolean
        {
            return this.constrained_edge[getPointIndexOffset(p, CCW_OFFSET)] = ce;
        }

        public function getDelaunayEdgeCW(p:Point):Boolean
        {
            return this.delaunay_edge[getPointIndexOffset(p, CW_OFFSET)];
        }

        public function setDelaunayEdgeCW(p:Point, e:Boolean):Boolean
        {
            return this.delaunay_edge[getPointIndexOffset(p, CW_OFFSET)] = e;
        }

        public function getDelaunayEdgeCCW(p:Point):Boolean
        {
            return this.delaunay_edge[getPointIndexOffset(p, CCW_OFFSET)];
        }

        public function setDelaunayEdgeCCW(p:Point, e:Boolean):Boolean
        {
            return this.delaunay_edge[getPointIndexOffset(p, CCW_OFFSET)] = e;
        }

        /**
         * The neighbor across to given point.
         */
        public function neighborAcross(p:Point):Triangle
        {
        ...
        public function legalize(opoint:Point, npoint:Point = null):void
        {
            if (npoint == null)
            {
                return this.legalize(this.points[0], opoint);
            }
        ...
        static public function getUniquePointsFromTriangles(triangles:Vector.<Triangle>):Vector.<Point>
        {
            ...
            {
                for each (point in triangle.points)
                {
                    points.push(point);
                }
            }
        ...
        static public function traceList(triangles:Vector.<Triangle>):void
        {
            ...
            {
                pointsMap[String(point)] = ++points_length;
            }
