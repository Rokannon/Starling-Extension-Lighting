...
package starling.extensions.lighting.core.display
{
    ...
    public class IrregularPolygon extends DisplayObject
    {
        ...
        //==========================================================================
        public function IrregularPolygon(nodes:Vector.<Point>, color:uint = 0xffffff,
                                         premultipliedAlpha:Boolean = false)
        {
            super();
            if (nodes.length < 3)
            {
                throw new ArgumentError("Invalid number of nodes");
            }
        ...
        override public function getBounds(targetSpace:DisplayObject, resultRect:Rectangle = null):Rectangle
        {
            ...
            var transformationMatrix:Matrix = targetSpace == this ? null : getTransformationMatrix(targetSpace,
                                                                                                   HELP_MATRIX);
        ...
        private static function registerPrograms():void
        {
            ...
            var vertexProgramCode:String = //"mov op, va0    \n" +    //copy position to output
